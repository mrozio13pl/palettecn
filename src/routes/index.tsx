...
import { ArrowLeft, ArrowRight, Code2Icon, PaletteIcon, PanelLeftIcon, PencilIcon, PlusIcon, ScanEyeIcon, Settings2Icon, SparkleIcon, Trash2Icon, TypeOutlineIcon } from 'lucide-react';
    ...
    return (
        <div className="size-full flex flex-col">
            ...
            <Tabs className="flex-1 flex-col flex min-h-0" defaultValue="ai">
                ...
                <TabsContent forceMount className="hidden w-full flex-1 min-h-0 data-[state=active]:flex flex-col m-0 border-none" value="ai">
                    <Chat ref={chatRef} />
                </TabsContent>
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        ...
                        <SelectContent position="popper">
                            {themes.filter(theme => Boolean(theme?.id)).map(theme => (
