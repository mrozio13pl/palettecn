...
export function LandingPage() {
    ...
    return (
        <>
            <Dialog open={npxDialogOpen} onOpenChange={setNpxDialogOpen}>
                <DialogContent>
                    <DialogTitle>Setup palettecn</DialogTitle>
                    <DialogDescription>
                        You must run palettecn locally. Run it using the following command:
                    </DialogDescription>
                    <Snippet text={command} />
                </DialogContent>
            </Dialog>
            <div className="relative size-full">
                <div className="size-full overflow-hidden -z-1 absolute inset-0">
                    <ParticleAnimation
                        particleCount={500}
                ...
                <div className="flex items-center flex-col mt-24 gap-y-2 overflow-hidden">
                    <h1 className="font-extrabold text-3xl sm:text-5xl sm:mr-8 inline text-center">
                        ...
                        <span className="bg-primary text-primary-foreground px-2 rounded-sm">
                            AI
                        </span>
                    </h1>
                    <p className="text-muted-foreground text-center px-12 mt-4">
                        Build stunning shadcn themes using premade color palettes and AI.
                    </p>
                    <div className="flex gap-2 [&_button]:px-8! mt-4">
                        <Button onClick={getStarted} className="font-bold">
                            Get started
                        </Button>
                    ...
                    <div className="flex flex-col items-center gap-y-4 mt-4">
                        <p className="text-muted-foreground text-center px-12">
                            Run palettecn locally and use your own AI providers.
                        </p>
                        <Snippet text={command} className="max-w-74" />
                    </div>

                    <div className="opacity-50 sm:w-xl w-3xs flex justify-center items-center [&_svg]:min-w-6 [&_svg]:fill-border text-border my-8">
