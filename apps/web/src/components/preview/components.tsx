...
function Profile() {
    ...
    const ProfileCardDemo = () => {
        const cardProps: GlassmorphismProfileCardProps = {
            ...
            bio: (
                <>
                    Bored, <span className="line-through">passionate</span> web developer and a real
                    Arch user.
                </>
            ),
            socialLinks: [
                {
                    ...
                    icon: Github,
                    label: 'GitHub',
                    href: 'https://github.com/mrozio13pl',
                },
                {
                    id: 'linkedin',
                    icon: LinkIcon,
                    label: 'Website',
                    href: 'https://mraza.pages.dev/',
                },
            ],
            actionButton: {
                text: 'Contact Me',
    ...
    const GlassmorphismProfileCard = ({
        ...
        return (
            <div className="relative w-full">
                <div className="relative flex flex-col items-center p-6 rounded-xl border bg-card">
