...
export const colorSegments: Record<string, Array<keyof ShadcnTheme>> = {
    'Primary Colors': ['background', 'foreground', 'primary', 'primaryForeground'],
    'Accents & Muted': [
        'secondary',
        'secondaryForeground',
        'muted',
    ...
    'Surfaces & Containers': ['card', 'cardForeground', 'popover', 'popoverForeground'],
    'System & Feedback': ['destructive', 'border', 'input', 'ring'],
    Sidebar: [
        'sidebar',
        'sidebarForeground',
        'sidebarPrimary',
